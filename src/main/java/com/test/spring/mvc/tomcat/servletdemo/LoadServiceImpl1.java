 ...
 */
public class LoadServiceImpl1 implements LoadService {

    public void loadOnStartup(ServletContext servletContext) {
        ServletRegistration.Dynamic initServlet = servletContext.addServlet("initServlet1", "com.test.spring.mvc.tomcat.servletdemo.servlets.InitServlet1");
